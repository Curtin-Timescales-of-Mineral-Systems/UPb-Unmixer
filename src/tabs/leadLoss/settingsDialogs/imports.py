...
from tabs.leadLoss.model import Column
...
class LeadLossImportSettingsDialog(AbstractImportSettingsDialog):
    ...
    def _createSettings(self):
        ...
        settings.inputErrorSigmas = utils.SIGMA_OPTIONS[self.inputSigmasRB.checkedId()]
        settings.inputErrorType = utils.ERROR_TYPE_OPTIONS[self.inputTypeRB.checkedId()]
        return settings